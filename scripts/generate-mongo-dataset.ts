...
async function generateTopicContent(
  ...
  const prompt = `
You are a world-class MongoDB and Database educator creating premium Instagram learning content.
...
1. hook_text
   ...
   - Example: "If you don't use this, your database will **crash** under heavy load."
...
6. common_edge_cases (Honest Caveat / Limitation)
   ...
   - Example: "⚠️ It speeds up reads but slows down writes significantly."
...
7. interview_question
   ...
   - Format: "When should you NOT use ${topic}? (Answer: when the overhead is too high)"
   - Max 25 words.
